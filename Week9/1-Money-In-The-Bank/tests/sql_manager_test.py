...
class SqlManagerTests(unittest.TestCase):
    ...
    def test_register(self):
        ...
        sql_manager.cursor.execute('SELECT Count(id)  FROM clients WHERE username = (?) AND password = (?)', ('Dinko', sql_manager.hash_password('123123')))
    ...
    def test_login(self):
        ...
        logged_user = sql_manager.login('Tester', sql_manager.hash_password('123'))
        self.assertEqual(logged_user.get_username(), 'Tester')

    def test_login_wrong_password(self):
        logged_user = sql_manager.login('Tester', sql_manager.hash_password('123567'))
    ...
    def test_change_password(self):
        logged_user = sql_manager.login('Tester', sql_manager.hash_password('123'))
        new_password = sql_manager.hash_password("12345")
